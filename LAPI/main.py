...
from . import svs
from LAPI.svs import TalkService
from LAPI.svs import LineLoginService
from LAPI.svs.ttypes import LoginRequest
...
UA, LA = ('Line/7.18.0 AppleWebKit/534.30"#"Line/6.0.0 iPad4,1 9.0.2', 'DESKTOPMAC 10.10.2-YOSEMITE-x64    MAC 4.5.0')
...
class qr():
    def get(self):
        ...
        qr = client.getAuthQrcode(keepLoggedIn=1, systemName="SRSU")
        uri = "Login URL" + " : " + "line://au/q/" + qr.verifier
